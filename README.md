...
## Introduction
We aim to build a prediction pipeline for an entire NBA season and postseason. Current leading industry methods are complex: https://fivethirtyeight.com/methodology/how-our-nba-predictions-work/.  We seek to design the best possible product from the ETL pipeline to the final prediction. Significant techniques we used in the project include K-means clustering, random forest classification, KNeighbors Classifier, Tableau Visualization, and Streamlit Dashboard.  We hope you enjoy it!
