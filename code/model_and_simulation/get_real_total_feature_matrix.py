...
print('Starting Process get_real_total_fea')
...
df = pd.concat(
    [df_team1_features, df_team1_matrix, df_team2_features, df_team2_matrix], axis=1
)
...
df.to_sql(
    'real_total_feature_matrix_data', con=engine, if_exists='replace', index=False
)
